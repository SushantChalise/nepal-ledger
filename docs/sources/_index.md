...
| Tier 1 | [mof-whitebook-foreign-aid](mof-whitebook-foreign-aid.md) | MoF | Source Book for Projects Financed with Foreign Assistance (White Book) | annual | manual_upload | active |
...
| Tier 2 | [nrb-concessional-loan](nrb-concessional-loan.md) | NRB | Interest-Subsidized / Concessional Loan Monthly Statistics | monthly | manual_upload | paused |
| Tier 2 | [nrb-db-financial-sector](nrb-db-financial-sector.md) | NRB | Database on Nepalese Economy — Financial Sector (BFI Assets, Deposits, Loans, Monetary Survey, Interest Rates, NEPSE) | monthly | manual_upload | paused |
| Tier 2 | [nrb-db-real-sector](nrb-db-real-sector.md) | NRB | Database on Nepalese Economy — Real Sector (GDP, CPI, Agriculture, Industry, Tourism, Energy) | quarterly | manual_upload | paused |
| Tier 2 | [nrb-fdi-bulletin](nrb-fdi-bulletin.md) | NRB | Status of FDI in Nepal (annual bulletin) | annual | manual_upload | paused |
| Tier 2 | [nrb-financial-stability-report](nrb-financial-stability-report.md) | NRB | Financial Stability Report | annual | manual_upload | paused |
...
| Tier 3 | [nrb-annual-report](nrb-annual-report.md) | NRB | NRB Annual Report (English + Nepali) | annual | manual_upload | paused |
| Tier 3 | [nrb-economic-bulletin](nrb-economic-bulletin.md) | NRB | Economic Bulletin & Indicators (Quarterly) | quarterly | manual_upload | paused |
...
| Tier 4 | [mof-intergovernmental](mof-intergovernmental.md) | MoF | Intergovernmental Fiscal Transfer details (per local level, by grant type) | annual | manual_upload | active |
