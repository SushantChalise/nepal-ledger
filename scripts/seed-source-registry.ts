...
const ROWS: readonly NewSourceRegistryRow[] = [
  ...
  },
  {
    ...
    sourceUrl: 'https://data.nsonepal.gov.np/dataset/poverty-status-2023',
    publicationFrequency: 'ad_hoc',
    reportingPeriodType: 'annual',
    fileFormat: 'pdf',
    requiresTableExtraction: true,
    historicalCoverage:
      'Decadal; NLSS-I 1995/96, NLSS-II 2003/04, NLSS-III 2010/11, NLSS-IV 2022/23',
    licenseStatus: 'gov_open',
    confidenceDefault: 'A',
    status: 'active',
    ingestionMode: 'manual_upload',
    tier: null,
    notes:
      'Summary report tables parsed via pdfplumber text extraction (not extract_tables). Archive: Financial Data/nso_nlss/. NLSS-IV 2022/23 ingested; NLSS-III comparison rows captured from Annex tables.',
  },
  {
